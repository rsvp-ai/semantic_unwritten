...
from .tokenization_grover import GroverTokenizer
...
from .configuration_gpt2 import GPT2Config, GPT2_PRETRAINED_CONFIG_ARCHIVE_MAP, GPT2ParaPosConfig
...
if is_torch_available():
    ...
    from .modeling_gpt2 import (GPT2PreTrainedModel, GPT2Model,
                                GPT2LMHeadModel, GPT2DoubleHeadsModel,GPT2LMHeadParaPosModel,
    ...
    from .modeling_grover import (GroverModel, GroverPreTrainedModel, GroverLMHeadModel,GroverMultiHeadModel,
                                  load_tf_weights_in_grover)
    from .modeling_bert_pos import (BertPosModel, BertPosForPreTraining,
                                BertPosForMaskedLM, BertPosForNextSentencePrediction,
                                BertPosForSequenceClassification, BertPosForMultipleChoice,
                                BertPosForTokenClassification, BertPosForQuestionAnswering,)
